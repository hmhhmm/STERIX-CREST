  ...
  return (
    <div>
      <header className="header">
        <h1>Testing Laboratory Dashboard</h1>
      ...
      <div className="dashboard">
        <div style={{marginBottom: '2rem'}}>
          ...
          <button 
            className={`btn ${activeTab === 'samples' ? '' : 'btn-secondary'}`}
            onClick={() => setActiveTab('samples')}
          >
            Sample Management
          </button>
          <button 
            className={`btn ${activeTab === 'results' ? '' : 'btn-secondary'}`}
            onClick={() => setActiveTab('results')}
          >
            Test Results
          </button>
          <button 
            className={`btn ${activeTab === 'equipment' ? '' : 'btn-secondary'}`}
